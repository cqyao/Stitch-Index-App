        ...
        {visibleV3 && (
          ...
          >
            <MainButton
              ...
              onPress={async () => {
                if (!imageUrl) {
                    // If user hasn't uploaded an image, use a default image
                    await uploadImage({ uri: "https://t3.ftcdn.net/jpg/05/16/27/58/360_F_516275801_f3Fsp17x6HQK0xQgDQEELoTuERO4SsWV.jpg" }, userId);
                }
